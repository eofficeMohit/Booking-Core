...
jQuery(function ($) {
    ...
    window.reloadForm = function (byUrl) {
        ...
        const orderFormData = orderForm.find('input,textarea,select').serializeArray().filter(function (x) {
            return x.value;
        });
        const params = [...filterFormData, ...advanceFormData, ...orderFormData];
