...
(function ($) {
    window.uploaderModal = new Vue({
        ...
        data: {
            ...
            folders: [],
            breadcrumbs: [],
            accept_type: planner.media.groups.default.mime.join(',')
        },
        mounted() {
            let me = this;
        ...
        methods: {
            ...
            show(configs) {
                ...
                this.accept_type = planner.media.groups[configs.file_type]['mime']
            },
            hide() {
                ...
                plannerApp.showConfirm({
                    ...
                    callback: function (result) {
                        if (result) {
                            me.isLoading = true;
                            $.ajax({
                                url: planner.admin_url + '/module/media/removeFiles',
                                type: 'POST',
                                data: {
                                ...
                                success: function (data) {
                                    if (data.status === 1) {
                                        //plannerApp.showSuccess(data);
                                    }
                                    if (data.status === 0) {
                                        plannerApp.showError(data);
                                    }
                                    me.isLoading = false;
                                    me.reloadLists();
                                },
            ...
            reloadLists() {
                ...
                me.isLoading = true;
                $.ajax({
                    url: planner.admin_url + '/module/media/getLists',
                    type: 'POST',
                    data: {
    ...
    Vue.component('folder-item', {
        ...
        methods: {
            deleteFolder: function () {
                ...
                this.saving = true;
                $.ajax({
                    url: planner.url + '/media/folder/delete',
                    data: {
                        id: this.folder.id,
                    },
                    type: 'post',
            ...
            saveName: function () {
                ...
                this.saving = true;
                $.ajax({
                    url: planner.url + '/media/folder/store',
                    data: {
                        id: this.folder.id,
