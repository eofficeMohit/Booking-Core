(function ($) {
    ...
    OsmMapEngine.prototype.initScripts = function (func) {
        ...
        script.src = planner.url_root + '/libs/leaflet1.4.0/leaflet.js';
        head.appendChild(script);

        var link = document.createElement('link');
        link.rel = 'stylesheet';
        link.href = planner.url_root + '/libs/leaflet1.4.0/leaflet.css';
    ...
    OsmMapEngine.prototype.addMarker = function (latLng, options) {
        ...
        //     options.icon_options.iconUrl = planner.url+'/images/favicon.png';
        // }
    ...
    GmapEngine.prototype.initScripts = function (func) {
        ...
        var script = document.createElement('script');
        script.type = 'text/javascript';
        script.src = 'https://maps.googleapis.com/maps/api/js?key=' + planner.map_gmap_key + '&libraries=places';
        head.appendChild(script);

        var script2 = document.createElement('script');
        script2.type = 'text/javascript';
        script2.src = planner.url + '/libs/infobox.js';
