    ...
    var hotelRoomForm = new Vue({
        ...
        mounted() {
            ...
            var options = {
                ...
                autoApply: true,
                disabledPast: true,
                dateFormat: planner.date_format,
                enableLoading: true,
                showEventTooltip: true,
                classNotAvailable: ['disabled', 'off'],
                disableHightLight: true,
                minDate: this.minDate,
                opens: planner.rtl ? 'left' : 'right',
                locale: {
            ...
            this.$nextTick(function () {
                $(this.$refs.start_date).daterangepicker(options).on('apply.daterangepicker',
                    function (ev, picker) {
                        ...
                        me.start_date_html = picker.startDate.format(planner.date_format) + ' <i class="fa fa-long-arrow-right" style="font-size: inherit"></i> ' + picker.endDate.format(planner.date_format);
                        // me.handleTotalPrice();
                    })
            })
        },
        methods: {
            ...
            checkAvailability: function () {
                ...
                if (!this.firstLoad) {
                    if (!this.start_date || !this.start_date) {
                        plannerApp.showError(this.i18n.date_required);
                        return;
                    }
                }
                this.onLoadAvailability = true;
                $.ajax({
                    url: planner.module.hotel + '/checkAvailability',
                    data: {
                        hotel_id: this.id,
            ...
            doSubmit: function (e) {
                ...
                $.ajax({
                    url: planner.url + '/booking/addToCart',
                    data: {
                        service_id: this.id,
                        service_type: "hotel",
                        start_date: this.start_date,
                    ...
                    success: function (res) {
                        ...
                        if (res.message) {
                            plannerApp.showAjaxMessage(res);
                        }
