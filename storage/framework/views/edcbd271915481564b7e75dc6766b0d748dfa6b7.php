                            ...
                            <?php if($rows->total() > 0): ?>
                                <?php $__currentLoopData = $rows; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $payout): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr class="status-<?php echo e($payout->status); ?>">
                                        ...
                                        <td>
                                            <a target="_blank" href="<?php echo e(route('user.admin.detail',['id'=>$payout->vendor_id])); ?>"><?php echo e($payout->vendor->getDisplayName()); ?></a>
                                        </td>
                                        <td>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/MAMP/htdocs/BookingCore/modules/Vendor/Views/admin/payouts/index.blade.php ENDPATH**/ ?>