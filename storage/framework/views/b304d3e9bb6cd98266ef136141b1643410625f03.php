        ...
        <div class="bravo_search_map <?php echo e(setting_item_with_lang("car_layout_map_option",false,"map_left")); ?>">
            ...
            <div class="results_item">
                ...
                <div class="listing_items ajax-search-result">
                    <?php echo $__env->make('Car::frontend.ajax.search-result-map', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                </div>
            </div>
        </div>
    </div>
...
<?php $__env->startPush('js'); ?>
    ...
    <script type="text/javascript" src="<?php echo e(asset('js/filter-map.js?_ver='.config('app.asset_version'))); ?>"></script>
<?php $__env->stopPush(); ?>

<?php echo $__env->make('layouts.app',['container_class'=>'container-fluid','header_right_menu'=>true], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/MAMP/htdocs/BookingCore/themes/BC/Car/Views/frontend/search-map.blade.php ENDPATH**/ ?>