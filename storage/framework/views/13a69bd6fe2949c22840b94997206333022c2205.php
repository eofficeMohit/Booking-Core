                ...
                <?php $__currentLoopData = $event_search_fields; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $field): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <div class="col-md-<?php echo e($field['size'] ?? "6"); ?> border-right">
                        <?php switch($field['field']):
                            ...
                            <?php break; ?>
                            <?php case ('attr'): ?>
                                <?php echo $__env->make('Event::frontend.layouts.search.fields.attr', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                            <?php break; ?>
                        <?php endswitch; ?>
                    </div>
...
<?php /**PATH /Applications/MAMP/htdocs/BookingCore/themes/BC/Event/Views/frontend/layouts/search/form-search.blade.php ENDPATH**/ ?>