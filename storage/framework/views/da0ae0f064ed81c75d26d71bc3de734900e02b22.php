            ...
            <div class="col-md-12 col-lg-6 ">
                <div class="panel">
                    <div class="panel-title d-flex justify-content-between">
                        ...
                        <a href="<?php echo e(route('report.admin.booking')); ?>" class="btn-link"><?php echo e(__("More")); ?>
                                ...
                                <?php if(count($recent_bookings) > 0): ?>
                                    <?php $__currentLoopData = $recent_bookings; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $booking): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            ...
                                            <td><?php echo e(format_money_main($booking->paid)); ?></td>
                                            <td>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/MAMP/htdocs/BookingCore/modules/Dashboard/Views/index.blade.php ENDPATH**/ ?>