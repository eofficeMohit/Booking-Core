        ...
        <form method="post" action="<?php echo e(route('LaravelInstaller::environmentSaveWizard')); ?>" class="tabs-wrap">
            <div class="tab" id="tab1content">
                ...
                <div class="form-group <?php echo e($errors->has('app_name') ? ' has-error ' : ''); ?>">
                    ...
                    <input type="text" name="app_name" id="app_name" value="Booking Core" placeholder="<?php echo e(trans('installer_messages.environment.wizard.form.app_name_placeholder')); ?>" />
            ...
            <div class="tab" id="tab2content">
                ...
                <div class="form-group <?php echo e($errors->has('admin_email') ? ' has-error ' : ''); ?>">
                    ...
                    <input type="text" name="admin_email" id="admin_email" value="" required placeholder="<?php echo e(trans('installer_messages.environment.wizard.form.app_admin_email_placeholder')); ?>" />
                ...
                <div class="form-group <?php echo e($errors->has('admin_password') ? ' has-error ' : ''); ?>">
                    ...
                    <input type="password" name="admin_password" id="admin_password" value="" required placeholder="<?php echo e(trans('installer_messages.environment.wizard.form.app_admin_password_placeholder')); ?>" />
...
<?php echo $__env->make('vendor.installer.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/MAMP/htdocs/BookingCore/resources/views/vendor/installer/environment-wizard.blade.php ENDPATH**/ ?>