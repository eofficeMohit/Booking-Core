                    ...
                    <form method="post" action="<?php echo e(route("contact.store")); ?>"  class="bravo-contact-block-form">
                        ...
                        <div class="contact-form">
                            ...
                            <div class="contact-form">
                                ...
                                <div class="form-group">
                                    <input type="text" value="" placeholder="<?php echo e(__('Phone')); ?>" name="phone" class="form-control">
                                </div>
                                <div class="form-group">
...
<?php /**PATH /Applications/MAMP/htdocs/BookingCore/themes/Base/Contact/Views/frontend/blocks/contact/index.blade.php ENDPATH**/ ?>