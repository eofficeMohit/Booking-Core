...
<?php $__env->startSection('content'); ?>
    <div class="bravo_search_event">
        <div class="bravo_banner" <?php if($bg = setting_item("event_page_search_banner")): ?> style="background-image: url(<?php echo e(get_file_url($bg,'full')); ?>)" <?php endif; ?> >
            <div class="container">
                <h1>
                    <?php echo e(setting_item_with_lang("event_page_search_title")); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/MAMP/htdocs/BookingCore/themes/BC/Event/Views/frontend/search.blade.php ENDPATH**/ ?>