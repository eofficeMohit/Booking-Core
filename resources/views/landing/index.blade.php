...
<head>
    <meta charset="UTF-8"/>
    <title>Planner - Ultimate Planner</title>
                ...
                <div class="col-xs-9">
                    <div class="dropdown dropdown-main-menu">
                        ...
                        <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                            <a class="dropdown-item" href="https://planner.co" target="_blank">Support</a>
                            <a target="_blank" class="dropdown-item" href="https://planner.co">Documentation</a>
                            <a target="_blank" href="{{config('landing.item_url')}}" class="dropdown-item btn-buynow">BUY NOW</a>
                        </div>
                    </div>
                    <ul class="menu">
                        <li>
                        ...
                        <li>
                            <a target="_blank" href="https://planner.co">Support</a>
                        </li>
                        <li>
                            <a target="_blank" href="https://planner.co">Documentation</a>
                        </li>
                    </ul>
                </div>
            </div>
    ...
    <div class="container">
        <div class="row ld-full-height">
            <div class="col-lg-6">
                ...
                {{--<p class="desc">Completed OTA Planner for Hotel, Room, Tour, Car, Rental, Activity likes--}}
...
<!--<img src="<?php /*echo $url . '/img/footer-corrner.png'; */?>" class="footer-corrner"/>-->
    <div class="container">
        <h3>Creating your own Booking<br />System with <span>Planner</span> is super<br />fast and easy <img src="{{url('landing/img/hand.svg')}}" /></h3>
        <a target="_blank"  href="{{config('landing.item_url')}}" class="btn-buynow">BUY NOW</a>
        <div class="social">
            <span>FOLLOW US</span>
            <ul>
                <li><a target="_blank" href="https://www.facebook.com/planner/"><svg width="10" height="19" viewBox="0 0 10 19" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <li><a target="_blank" href="#"><svg width="20" height="14" viewBox="0 0 20 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <li>
                    <a href="mailto:contact@planner.co">
